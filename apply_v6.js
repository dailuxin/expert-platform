...
if (html.includes(target2)) {
  ...
  console.log('2. homeExtras added');
}
...
console.log('3. Functions added');

fs.writeFileSync('C:\\Users\\dailu\\Desktop\\expert-platform\\public\\index.html', html, 'utf8');
console.log('Saved');
